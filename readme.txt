...
================================
-run_doCholesky.sh (shell script for temporarily setting environment variables and 
 executing the application)
   -to run the shell script, type
   
       ./run_doCholesky.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v85, run the shell script as:
       ...
       ./run_doCholesky.sh /mathworks/home/application/v85
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_doCholesky.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
   -if end users are unable to download the MATLAB runtime using the above  
    link, include it when building your component by clicking 
    the "Runtime downloaded from web" link in the Deployment Tool
-The Macintosh bundle directory structure doCholesky.app 
   -this can be gathered up using the zip command 
    zip -r doCholesky.zip doCholesky.app
    or the tar command 
    tar -cvf doCholesky.tar doCholesky.app
-This readme file 
...
A. Mac systems:
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_doCholesky.sh 
